...
layout: default
title: 富山県の自治体一覧
permalink: /registration-search/toyama/
---
...
<div class="custom-header">
  <div class="custom-title">富山県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-na" class="menu-btn">な行</a> <a href="#row-ha" class="menu-btn">は行</a>
  </div>
...
const ids = {"あ行":"row-a","か行":"row-ka","た行":"row-ta","な行":"row-na","は行":"row-ha"};
