...
layout: default
title: 沖縄県の自治体一覧
permalink: /registration-search/okinawa/
---
...
<div class="custom-header">
  <div class="custom-title">沖縄県の自治体検索</div>
</div>
...
const pref = "沖縄県";
const data = {
  "あ行": ["粟国村", "伊江村", "石垣市", "伊平屋村", "伊是名村", "糸満市", "浦添市", "うるま市", "大宜味村", "沖縄市", "恩納村"],
  "か行": ["嘉手納町", "北大東村", "北中城村", "宜野湾市", "宜野座村", "金武町", "国頭村", "久米島町"],
  "さ行": ["座間味村"],
