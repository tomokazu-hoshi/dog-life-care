...
layout: default
title: 奈良県の自治体一覧
permalink: /registration-search/nara/
---
...
<div class="custom-header">
  <div class="custom-title">奈良県の自治体検索</div>
</div>
...
const pref = "奈良県";
const data = {
  "あ行": ["明日香村", "安堵町", "生駒市", "斑鳩町", "宇陀市", "王寺町", "大淀町"],
  "か行": ["香芝市", "橿原市", "河合町", "川上村", "川西町", "上牧町", "黒滝村", "広陵町", "五條市", "御所市"],
  "さ行": ["桜井市", "三郷町", "下市町", "下北山村", "曽爾村"],
  "た行": ["高取町", "田原本町", "天理市", "十津川村"],
  "な行": ["奈良市", "野迫川村"],
  "は行": ["東吉野村", "平群町"],
  "ま行": ["御杖村", "三宅町"],
  "や・わ行": ["山添村", "大和郡山市", "大和高田市", "吉野町"]
};
