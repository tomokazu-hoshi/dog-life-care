...
layout: default
title: 熊本県の自治体一覧
permalink: /registration-search/kumamoto/
---
...
<div class="custom-header">
  <div class="custom-title">熊本県の自治体検索</div>
</div>
...
const pref = "熊本県";
const data = {
  "あ行": ["あさぎり町", "芦北町", "阿蘇市", "天草市", "荒尾市", "五木村", "産山村", "宇城市", "宇土市", "大津町", "小国町"],
  "か行": ["嘉島町", "上天草市", "菊池市", "菊陽町", "玉東町", "球磨村", "甲佐町", "合志市", "熊本市"],
  "さ行": ["相良村"],
  "た行": ["高森町", "多良木町", "玉名市", "津奈木町"],
  "な行": ["長洲町", "和水町", "南関町", "錦町", "西原村"],
  "は行": ["氷川町", "人吉市"],
  "ま行": ["益城町", "美里町", "水上村", "水俣市", "御船町", "南阿蘇村", "南小国町"],
