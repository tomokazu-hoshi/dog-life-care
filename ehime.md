...
layout: default
title: 愛媛県の自治体一覧
permalink: /registration-search/ehime/
---
...
<div class="custom-header">
  <div class="custom-title">愛媛県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ta" class="menu-btn">た行</a> <a href="#row-na" class="menu-btn">な行</a> <a href="#row-ma" class="menu-btn">ま行</a>
...
const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","た行":"row-ta","な行":"row-na","ま行":"row-ma","や行":"row-ya"};
