...
layout: default
title: 岐阜県の自治体一覧
permalink: /registration-search/gifu/
---
...
<div class="custom-header">
  <div class="custom-title">岐阜県の自治体検索</div>
</div>
...
const pref = "岐阜県";
const data = {
  "あ行": ["安八町", "池田町", "揖斐川町", "恵那市", "大垣市", "大野町"],
  "か行": ["海津市", "各務原市", "笠松町", "岐阜市", "郡上市", "下呂市", "神戸町"],
  "さ行": ["坂祝町", "白川町", "白川村", "関市", "関ケ原町"],
  "た行": ["高山市", "多治見市", "垂井町", "土岐市", "富加町"],
  "な行": ["中津川市"],
  "は行": ["羽島市", "東白川村", "飛騨市", "七宗町"],
  "ま行": ["瑞浪市", "瑞穂市", "御嵩町", "美濃市", "美濃加茂市", "本巣市"],
  "や行": ["八百津町", "山県市", "養老町"],
  "わ行": ["輪之内町"]
};
