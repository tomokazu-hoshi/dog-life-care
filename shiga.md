...
layout: default
title: 滋賀県の自治体一覧
permalink: /registration-search/shiga/
---
...
<div class="custom-header">
  <div class="custom-title">滋賀県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ya" class="menu-btn">や行</a> <a href="#row-ra" class="menu-btn" style="grid-column: span 2;">ら行</a>
  </div>
...
const ids = {"あ行":"row-a","か行":"row-ka","た行":"row-ta","な行":"row-na","は行":"row-ha","ま行":"row-ma","や行":"row-ya","ら行":"row-ra"};
