...
layout: default
title: 福島県の自治体一覧
permalink: /registration-search/fukushima/
---
...
<div class="custom-header">
  <div class="custom-title">福島県の自治体検索</div>
</div>
...
const pref = "福島県";
const data = {
  "あ行": ["会津坂下町", "会津美里町", "会津若松市", "浅川町", "飯舘村", "石川町", "猪苗代町", "いわき市"],
  "か行": ["鏡石町", "金山町", "川俣町", "川内村", "喜多方市", "国見町", "郡山市"],
  "さ行": ["鮫川村", "下郷町", "白河市", "新地町", "須賀川市", "相馬市"],
  "た行": ["只見町", "玉川村", "棚倉町", "伊達市", "田村市", "天栄村"],
  "na行": ["中島村", "浪江町", "楢葉町", "西会津町", "西郷村", "二本松市"],
  "は行": ["塙町", "磐梯町", "檜枝岐村", "平田村", "広野町", "福島市", "古殿町"],
  "ま行": ["三春町", "南会津町", "南相馬市", "三島町", "本宮市"],
  "や行": ["矢祭町", "矢吹町", "柳津町"]
};
