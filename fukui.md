...
layout: default
title: 福井県の自治体一覧
permalink: /registration-search/fukui/
---
...
<div class="custom-header">
  <div class="custom-title">福井県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ma" class="menu-btn">ま行</a> <a href="#row-wa" class="menu-btn">わ行</a>
  </div>
...
const pref = "福井県";
const data = {
  "あ行": ["あわら市", "池田町", "永平寺町", "越前市", "越前町", "おおい町", "大野市", "小浜市"],
  "か行": ["勝山市"],
  "さ行": ["坂井市", "鯖江市"],
  "た行": ["高浜町", "敦賀市"],
  "な行": ["南越前町"],
...
const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","た行":"row-ta","な行":"row-na","は行":"row-ha","ま行":"row-ma","わ行":"row-wa"};
