...
layout: default
title: 広島県の自治体一覧
permalink: /registration-search/hiroshima/
---
...
<div class="custom-header">
  <div class="custom-title">広島県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ta" class="menu-btn">た行</a> <a href="#row-ha" class="menu-btn">は行</a> <a href="#row-ma" class="menu-btn">ま行</a>
  </div>
...
const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","た行":"row-ta","は行":"row-ha","ま行":"row-ma"};
