...
<style>
  /* 1. 【最優先】テーマが勝手に出すタイトルやヘッダーを「跡形もなく」消す */
  header.site-header, 
  .site-header, 
  .page-title, 
  h1:first-of-type, 
  ...
  /* 写真の上のテキスト（影を強くして読みやすくしました） */
  .hero-text { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 100%; text-align: center; color: white; text-shadow: 2px 2px 8px rgba(0,0,0,0.9); }
