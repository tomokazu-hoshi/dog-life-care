...
<style>
  ...
  .h-main { font-size: 26px; font-weight: 900; margin-bottom: 12px; }
...
<div class="grid-container">
  ...
  <a href="{{ '/rescue-guide/' | relative_url }}" class="grid-card"><span class="card-icon">🐕</span><span class="card-label">元野犬・雑種</span></a>
</div>
