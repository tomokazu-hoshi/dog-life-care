...
layout: default
title: 佐賀県の自治体一覧
permalink: /registration-search/saga/
---
...
<div class="custom-header">
  <div class="custom-title">佐賀県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ta" class="menu-btn">た行</a> <a href="#row-ma" class="menu-btn">ま行</a> <a href="#row-ya" class="menu-btn">や行</a>
  </div>
...
const data = {
  ...
  "か行": ["鹿島市", "上峰町", "唐津市", "神埼市", "基山町", "玄海町", "江北町"],
  "さ行": ["佐賀市", "白石町"],
  "た行": ["多久市", "武雄市", "太良町", "鳥栖市"],
  "ま行": ["みやき町"],
  "や行": ["吉野ヶ里町"]
...
const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","た行":"row-ta","ま行":"row-ma","や行":"row-ya"};
