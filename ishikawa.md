...
layout: default
title: 石川県の自治体一覧
permalink: /registration-search/ishikawa/
---
...
<div class="custom-header">
  <div class="custom-title">石川県の自治体検索</div>
</div>
...
const data = {
  "あ行": ["穴水町"],
  "か行": ["加賀市", "金沢市", "かほく市", "川北町", "小松市"],
  "さ行": ["珠洲市", "志賀町"],
  "た行": ["津幡町", "宝達志水町"],
  "な行": ["七尾市", "能美市", "野々市市", "中能登町", "能登町"],
  "は行": ["白山市", "羽咋市"],
  "わ行": ["輪島市"]
};

const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","た行":"row-ta","な行":"row-na","は行":"row-ha","わ行":"row-wa"};
