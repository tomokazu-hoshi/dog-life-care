...
layout: default
title: 宮崎県の自治体一覧
permalink: /registration-search/miyazaki/
---
...
<div class="custom-header">
  <div class="custom-title">宮崎県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ma" class="menu-btn" style="grid-column: span 3;">ま行</a>
  </div>
...
const data = {
  "あ行": ["綾町", "えびの市"],
  "か行": ["門川町", "川南町", "木城町", "串間市", "国富町", "五ヶ瀬町", "小林市"],
  "さ行": ["西都市", "椎葉村", "新富町"],
  "た行": ["高千穂町", "高鍋町", "高原町", "都農町"],
  "な行": ["西米良村", "日南市", "延岡市"],
  "は行": ["日之影町", "日向市"],
  "ま行": ["三股町", "美郷町", "都城市", "宮崎市", "諸塚村"]
};
