...
layout: default
title: 静岡県の自治体一覧
permalink: /registration-search/shizuoka/
---
...
<div class="custom-header">
  <div class="custom-title">静岡県の自治体検索</div>
</div>
...
const pref = "静岡県";
const data = {
  "あ行": ["熱海市", "伊豆市", "伊豆の国市", "伊東市", "磐田市", "御前崎市", "小山町"],
  "か行": ["掛川市", "函南町", "河津町", "川根本町", "菊川市", "湖西市", "御殿場市"],
  "さ行": ["静岡市", "島田市", "清水町", "下田市", "裾野市"],
  "な行": ["長泉町", "西伊豆町", "沼津市"],
  "は行": ["浜松市", "東伊豆町", "袋井市", "藤枝市", "富士市", "富士宮市"],
  "ま行": ["牧之原市", "松崎町", "三島市", "南伊豆町", "森町"],
  "や行": ["焼津市", "吉田町"]
};

const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","な行":"row-na","は行":"row-ha","ま行":"row-ma","や行":"row-ya"};
