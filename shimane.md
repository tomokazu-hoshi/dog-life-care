...
layout: default
title: 島根県の自治体一覧
permalink: /registration-search/shimane/
---
...
<div class="custom-header">
  <div class="custom-title">島根県の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    <a href="#row-a" class="menu-btn">あ行</a> <a href="#row-ka" class="menu-btn">か行</a> <a href="#row-ta" class="menu-btn">た行</a>
    <a href="#row-na" class="menu-btn">な行</a> <a href="#row-ha" class="menu-btn">は行</a> <a href="#row-ma" class="menu-btn">ま行</a>
    <a href="#row-ya" class="menu-btn" style="grid-column: span 3;">や行</a>
  </div>
...
const pref = "島根県";
const data = {
  "あ行": ["海士町", "飯南町", "出雲市", "雲南市", "大田市", "隠岐の島町", "奥出雲町", "邑南町"],
  "か行": ["川本町", "江津市"],
  "た行": ["知夫村", "津和野町"],
  "na行": ["西ノ島町"],
  "は行": ["浜田市"],
...
const ids = {"あ行":"row-a","か行":"row-ka","た行":"row-ta","na行":"row-na","は行":"row-ha","ま行":"row-ma","や行":"row-ya"};

const container = document.getElementById('lists');
for (const [row, cities] of Object.entries(data)) {
  const section = document.createElement('section');
  section.id = ids[row] || "row-default";
