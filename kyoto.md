...
layout: default
title: 京都府の自治体一覧
permalink: /registration-search/kyoto/
---
...
<div class="custom-header">
  <div class="custom-title">京都府の自治体検索</div>
</div>
...
<div class="container">
  ...
  <div class="menu-grid">
    ...
    <a href="#row-ya" class="menu-btn">や行</a> <a href="#row-wa" class="menu-btn" style="grid-column: span 2;">わ行</a>
  </div>
...
const ids = {"あ行":"row-a","か行":"row-ka","さ行":"row-sa","な行":"row-na","は行":"row-ha","ま行":"row-ma","や行":"row-ya","わ行":"row-wa"};
